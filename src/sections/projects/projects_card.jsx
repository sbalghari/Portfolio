...
function ProjectCard({ data }) {
    ...
    return (
        <div className="shadow-lg hover:scale-105 hover:border transition all duration-300 hover:border-primary bg-white dark:bg-secondary text-start text-lightText dark:text-darkText p-4 rounded-xl">
